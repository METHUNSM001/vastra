...
export const AdminDashboard = () => {
  ...
  return (
    <div style={{ backgroundColor: "#F7F5F2", minHeight: "100vh", paddingBottom: "60px" }}>
      
      {/* Admin Top Header */}
      <div style={{ backgroundColor: "#20171B", color: "#FFFFFF", padding: "16px 24px", borderBottom: "2px solid var(--brand-secondary)" }}>
      ...
      <div className="container-wide" style={{ padding: "30px 24px" }}>
        ...
        {activeAdminTab === "dashboard" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "20px", marginBottom: "32px" }}>
              ...
              <div style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-light)", boxShadow: "var(--shadow-sm)" }}>
                <div style={{ fontSize: "0.82rem", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>Total Sales Revenue</div>
              ...
              <div style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-light)", boxShadow: "var(--shadow-sm)" }}>
                <div style={{ fontSize: "0.82rem", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>Total Orders Placed</div>
                <div style={{ fontSize: "1.8rem", fontWeight: "700", color: "var(--text-main)", marginTop: "4px" }}>
                  {totalOrdersCount}
                </div>
              ...
              <div style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-light)", boxShadow: "var(--shadow-sm)" }}>
                <div style={{ fontSize: "0.82rem", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>Active Catalog Products</div>
                <div style={{ fontSize: "1.8rem", fontWeight: "700", color: "var(--text-main)", marginTop: "4px" }}>
                  {products.length}
                </div>
                <div style={{ fontSize: "0.78rem", color: "var(--text-secondary)", marginTop: "4px" }}>
              ...
              <div style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-light)", boxShadow: "var(--shadow-sm)" }}>
                <div style={{ fontSize: "0.82rem", color: "var(--text-muted)", fontWeight: "600", textTransform: "uppercase" }}>Low Stock Alert</div>
        ...
        {activeAdminTab === "products" && (
          <div>
            <div className="flex items-center justify-between" style={{ marginBottom: "20px" }}>
              <h2 style={{ fontSize: "1.4rem", fontWeight: "700" }}>Manage Product Catalog</h2>
                    ...
                    <tr key={prod.id} style={{ borderBottom: "1px solid var(--border-light)" }}>
                      <td style={{ padding: "12px 16px" }}>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <strong style={{ display: "block" }}>{prod.nameEn}</strong>
                            <span style={{ fontSize: "0.78rem", color: "var(--text-muted)" }}>{prod.nameTa}</span>
                          </div>
                        </div>
                      </td>
                      <td style={{ padding: "12px 16px", textTransform: "capitalize" }}>{prod.category}</td>
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        <div className="flex gap-2">
                          <button onClick={() => handleOpenProductModal(prod)} style={{ background: "none", color: "var(--brand-primary)", padding: "4px" }}>
                            <Edit size={16} />
                          </button>
                          <button onClick={() => handleDeleteProduct(prod.id)} style={{ background: "none", color: "#DC2626", padding: "4px" }}>
                            <Trash2 size={16} />
                          </button>
                        </div>
                      </td>
        ...
        {activeAdminTab === "orders" && (
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {orders.map((ord) => (
                <div key={ord.id} style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-light)", boxShadow: "var(--shadow-sm)" }}>
                  
                  <div className="flex items-center justify-between" style={{ borderBottom: "1px solid var(--border-light)", paddingBottom: "12px", marginBottom: "14px", flexWrap: "wrap", gap: "12px" }}>
                    <div>
                      ...
                      <span style={{ marginLeft: "14px", fontSize: "0.85rem", color: "var(--text-secondary)" }}>
                        Customer: <strong>{ord.customer?.name}</strong> (+91 {ord.customer?.phone})
                      </span>
                    </div>
        ...
        {activeAdminTab === "inventory" && (
          <div>
            <h2 style={{ fontSize: "1.4rem", fontWeight: "700", marginBottom: "20px" }}>Inventory & Replenishment Monitor</h2>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.88rem" }}>
                <thead>
                  <tr style={{ backgroundColor: "var(--bg-secondary)", textAlign: "left" }}>
                    ...
                    <th style={{ padding: "12px 16px" }}>Quick Restock</th>
                  </tr>
                </thead>
                <tbody>
                  {products.map((p) => (
                    <tr key={p.id} style={{ borderBottom: "1px solid var(--border-light)" }}>
                      <td style={{ padding: "12px 16px", fontWeight: "600" }}>{p.sku || p.id}</td>
                      <td style={{ padding: "12px 16px" }}>{p.nameEn}</td>
        ...
        {activeAdminTab === "coupons" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: "20px" }}>
              {coupons.map((c) => (
                <div key={c.id} style={{ backgroundColor: "#FFFFFF", padding: "20px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-light)", boxShadow: "var(--shadow-sm)" }}>
                  ...
                  <div style={{ fontSize: "0.95rem", fontWeight: "600", marginBottom: "4px" }}>{c.descriptionEn}</div>
                  <div style={{ fontSize: "0.8rem", color: "var(--text-muted)" }}>Min Order: ₹{c.minOrderValue} | Max Discount: ₹{c.maxDiscount}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      {showProductModal && (
        <div style={{ position: "fixed", inset: 0, zIndex: 1000, backgroundColor: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
          <div style={{ backgroundColor: "#FFFFFF", padding: "30px", borderRadius: "var(--radius-lg)", maxWidth: "600px", width: "100%", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <form onSubmit={handleSaveProduct} style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              <div>
                <label style={{ fontSize: "0.85rem", fontWeight: "600", display: "block", marginBottom: "4px" }}>English Name *</label>
                <input type="text" required value={pNameEn} onChange={(e) => setPNameEn(e.target.value)} style={{ width: "100%" }} />
              </div>

              <div>
                <label style={{ fontSize: "0.85rem", fontWeight: "600", display: "block", marginBottom: "4px" }}>Tamil Name (தமிழ்)</label>
                <input type="text" value={pNameTa} onChange={(e) => setPNameTa(e.target.value)} style={{ width: "100%" }} />
              </div>
      ...
      {showCouponModal && (
        <div style={{ position: "fixed", inset: 0, zIndex: 1000, backgroundColor: "rgba(0,0,0,0.6)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
          <div style={{ backgroundColor: "#FFFFFF", padding: "30px", borderRadius: "var(--radius-lg)", maxWidth: "420px", width: "100%" }}>
            <h3 style={{ fontSize: "1.2rem", fontWeight: "700", marginBottom: "16px" }}>Create Coupon</h3>
            <form onSubmit={handleCreateCoupon} style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              <div>
                <label style={{ fontSize: "0.85rem", fontWeight: "600", display: "block", marginBottom: "4px" }}>Coupon Code</label>
                <input type="text" required value={cCode} onChange={(e) => setCCode(e.target.value)} placeholder="e.g. FESTIVE20" style={{ width: "100%", textTransform: "uppercase" }} />
              </div>
              <div>
                <label style={{ fontSize: "0.85rem", fontWeight: "600", display: "block", marginBottom: "4px" }}>Discount Percentage (%)</label>
                <input type="number" required value={cPercent} onChange={(e) => setCPercent(e.target.value)} style={{ width: "100%" }} />
              </div>
              <div>
                <label style={{ fontSize: "0.85rem", fontWeight: "600", display: "block", marginBottom: "4px" }}>Minimum Order Value (₹)</label>
                <input type="number" required value={cMinOrder} onChange={(e) => setCMinOrder(e.target.value)} style={{ width: "100%" }} />
              </div>
              <div className="flex justify-between" style={{ marginTop: "12px" }}>
